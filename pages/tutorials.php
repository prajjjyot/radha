      ...
      <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasNavbar" aria-labelledby="offcanvasNavbarLabel">
        ...
        <div class="offcanvas-body">
          <ul class="navbar-nav justify-content-center flex-grow-1 pe-3">
            ...
            <li class="nav-item">
              <a class="nav-link active" aria-current="page"  href="tutorials.php">Tutorials</a>
            </li>
  ...
  <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasNavbar" aria-labelledby="offcanvasNavbarLabel">
    ...
    <div class="offcanvas-body">
      <ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
        ...
        <li class="nav-item">
          <a class="nav-link active" aria-current="page"  href="tutorials.php">Tutorial</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="about.php">About</a>
        </li>
...
<p class="text-muted">
  Watch this step-by-step video to learn how to generate 25+ SQL queries and ready-to-use PHP functions instantly with QGen — no manual coding required.
</p>
